...
class Adafruit_StepperMotor {
 public:
  ...
  int step(uint16_t steps, uint8_t dir,  uint8_t style = SINGLE);
  void forceStep(uint16_t steps, uint8_t dir, uint8_t style = SINGLE);
  ...
  void killPins(int left, int right, int kill);
